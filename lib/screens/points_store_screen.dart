...
/// Pantalla de tienda de puntos.
///
/// Esta clase contiene la interfaz de la pantalla que se muestra después de presionar el botón de tienda de puntos en el menú inferior de la aplicación.
/// En esta pantalla aparecen los puntos acumulados por el usuario y los productos canjeables por estos.
...
class _PointsStoreScreenState extends State<PointsStoreScreen> {
  ...
  /// Widget que construye la interfaz de la pantalla de tienda de puntos de la aplicación.
  ///
  /// Este widget muestra la pantalla de tienda de puntos después de presionar el botón de tienda de puntos en el menú inferior de la aplicación.
